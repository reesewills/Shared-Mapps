...
import kotlinx.android.synthetic.main.fragment_saved_mapps.*
import kotlinx.android.synthetic.main.map_item.view.*
import java.util.ArrayList

@SuppressLint("ValidFragment")
class SavedMappsFragment(context: Context): Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return layoutInflater.inflate(R.layout.fragment_saved_mapps, container, false)
    }
    ...
    override fun onStart() {
        ...
        my_followed_maps.layoutManager = LinearLayoutManager(parentContext)
        (my_followed_maps as RecyclerView).addItemDecoration(DividerItemDecoration(context, DividerItemDecoration.VERTICAL))
        viewModel = ViewModelProviders.of(this).get(MapViewModel::class.java)



        val observer = Observer<ArrayList<Map>> {
            (my_followed_maps as RecyclerView).adapter = adapter
        ...
        viewModel.getFollowedMaps().observe(this, observer)
    }
